...
const Top = () => {
  return (
    <div>
      ...
      <div className='flex items-center mt-10 absolute top-40'>
        <div className='pl-20 pr-20'>
          ...
          <div className='flex pt-10 pb-10 pl-7 pr-12 absolute left-12 justify-center grid-cols-2 gap-5'>
            <div className='btn bg-[#FFBE00] leading-normal'>Resgister</div>
            <div className='btn bg-black text-white leading-normal'>Log In</div>
          </div>
        </div>
      ...
      <div className=' absolute bottom-0 pl-20 pr-20 pt-16 grid lg:grid-cols-3 gap-5'>
        <div className='service text-center p-4'>
          <img className='w-25 p-3' src="img/planner.png" alt="" />
          <div>
            ...
            <div className='btn-service text-center'><img className='w-4 absolute right-36 bottom-8' src="img/vector2.png" alt="" />Hire </div>
          </div>   
        </div>
        ...
        <div className='service text-center p-4'>
          ...
          <div>
            ...
            <div className='btn-service'><img className='w-4 absolute right-36 bottom-8' src="img/vector2.png" alt="" />Order</div>
          </div>   
        </div>
        ...
        <div className='service text-center p-5'>
          ...
          <div>
            ...
            <div className='btn-service'><img className='w-4 absolute right-32 bottom-8' src="img/vector2.png" alt="" />Explore</div>
          </div>   
        </div>
      </div>
      </div>
      ...
      <div className='pl-20 pr-20 mb-12 mt-7 grid lg:grid-cols-3 gap-5'>
        <div className=' p-2 bg-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)]'>
          <div className='bg-[#D9D9D9] p-28 mb-7 rounded-md'>
            <div className='btn w-28 h-8 bg-[#EEC89F] absolute right-4 top-48'>Cakes</div>
          </div>
          ...
          <p className='text-xs text-[#484848] font-semibold pt-2 flex'>4.5 <img className='w-6 h-4 pl-1 pr-1' src="img/star.png" alt="" /> <u className='hover:text-[#FFD700] cursor-pointer'>Reviews</u></p>
          ...
          <div className='bg-[#FFD700] hover:bg-[#D4B300] rounded-md py-2 px-3 text-xs font-bold cursor-pointer tracking-wider text-center'>
            <img className='w-5 m-2 inline-block' src="img/vector.png" alt="" />
            Add To Cart
            </div>
        </div>
      ...
      <div className=' pl-4 pr-4 grid lg:grid-cols-2 gap-0 absolute bottom-24'>
        <div className='p-6 pb-10 bg-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)] rounded-md m-10 relative left-7'>
          ...
          <img className='w-7 absolute right-0 bottom-0' src="img/quotedown.png" alt="" />
        </div>
        ...
        <div className='bg-[#000000] p-8 pl-11 pr-11 grid lg:grid-cols-2 gap-5'>
            ...
            <div className='pl-12 pt-5 pb-5'>
              ...
              <div className='relative'>
                ...
                <input className='bg-[#FFD700] p-2 w-10 mt-3 rounded-r-md cursor-pointer' type="text" />
                <img className='pl-0 absolute left-52 top-6 cursor-pointer' src="img/vector2.png" alt="" />
              </div>
            
              <div className='flex pt-4'>
                <img className='w-7 h-7 cursor-pointer ' src="img/likedin.png" alt="" />
                <img className='w-7 h-7 ml-5 cursor-pointer' src="img/instagram.png" alt="" />
                <img className='w-7 h-7 ml-5 cursor-pointer' src="img/twitter.png" alt="" />
              </div>
            </div>
